...
HD_PWD='C:/Users/Ciudad Maderas/Documents/GCPU_implementation-/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPPU.tcl
