...
HD_PWD='C:/Users/Ciudad Maderas/Documents/GCPU_implementation-/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPPU.tcl -notrace
